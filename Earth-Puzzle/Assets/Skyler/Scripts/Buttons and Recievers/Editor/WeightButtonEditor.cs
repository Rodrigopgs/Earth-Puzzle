...
[CustomEditor(typeof(WeightButton))]
[CanEditMultipleObjects]
public class WeightButtonEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (type.enumValueFlag == (int)WeightButton.WeightButtonType.Sprite)
        {
            EditorGUILayout.PropertyField(inactive);
            EditorGUILayout.PropertyField(active);
        }
        else if (type.enumValueFlag == (int)WeightButton.WeightButtonType.Animation)
        {
